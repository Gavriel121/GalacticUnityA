...
public class Enemy03Engine : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        RandomTimeToShoot = Random.Range(3, 5);
    ...
    public void ChangeDir() // פונקציה שארחראית על שינוי התנועה 
    {
        ...
        Speed = Random.Range(0.01f, 0.02f); // משנה את המהירות 
        Invoke("ChangeDir", 5);
    }
    ...
    void OnDestroy()// פונקציה שמתבצעת רק כאשר האובייקט נהרס
    {
        ...
        int ChanceToLaser = Random.RandomRange(1, 12);// אחראי על הסיכוי באמת שהשחקן יקבל יריות כרגע הסיכוי לקבל גבוה כי אני רוצה רק לבדוק שהכל עובד
        int ChanceToShield = Random.RandomRange(1, 18);  // אחראי על הסיכוי באמת שהשחקן יקבל מגן כרגע הסיכוי לקבל גבוה כי אני רוצה רק לבדוק שהכל עובד
        int ChanceToRepair = Random.RandomRange(1, 23);
